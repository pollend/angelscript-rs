...
//     let make = OsString::from(format!("make {:?}", makefile.to_string_lossy().replace("\\", "/")));
...
fn prebuild() -> io::Result<()> {
    let angelscript_dir : PathBuf = match env::var_os("ANGELSCRIPT_LOCAL_SOURCE") {
        ...
        None => {
            ...
            dir.push("angelscript");
            dir
        }
    };

    let wrapper_header = angelscript_dir.join("include/wrapper.hpp");
    println!("cargo:rerun-if-changed={}", wrapper_header.to_string_lossy());
    ...
    cc::Build::new()
        .include(angelscript_dir.join("include"))
        .warnings(false)
        .file(angelscript_dir.join("source/as_atomic.cpp"))
        .file(angelscript_dir.join("source/as_builder.cpp"))
        .file(angelscript_dir.join("source/as_bytecode.cpp"))
        .file(angelscript_dir.join("source/as_callfunc.cpp"))
        .file(angelscript_dir.join("source/as_callfunc_mips.cpp"))
        .file(angelscript_dir.join("source/as_callfunc_x86.cpp"))
        .file(angelscript_dir.join("source/as_callfunc_x64_gcc.cpp"))
        .file(angelscript_dir.join("source/as_callfunc_x64_msvc.cpp"))
        .file(angelscript_dir.join("source/as_callfunc_x64_mingw.cpp"))
        .file(angelscript_dir.join("source/as_compiler.cpp"))
        .file(angelscript_dir.join("source/as_configgroup.cpp"))
        .file(angelscript_dir.join("source/as_context.cpp"))
        .file(angelscript_dir.join("source/as_datatype.cpp"))
        .file(angelscript_dir.join("source/as_gc.cpp"))
        .file(angelscript_dir.join("source/as_generic.cpp"))
        .file(angelscript_dir.join("source/as_globalproperty.cpp"))
        .file(angelscript_dir.join("source/as_memory.cpp"))
        .file(angelscript_dir.join("source/as_module.cpp"))
        .file(angelscript_dir.join("source/as_objecttype.cpp"))
        .file(angelscript_dir.join("source/as_outputbuffer.cpp"))
        .file(angelscript_dir.join("source/as_parser.cpp"))
        .file(angelscript_dir.join("source/as_restore.cpp"))
        .file(angelscript_dir.join("source/as_scriptcode.cpp"))
        .file(angelscript_dir.join("source/as_scriptengine.cpp"))
        .file(angelscript_dir.join("source/as_scriptfunction.cpp"))
        .file(angelscript_dir.join("source/as_scriptnode.cpp"))
        .file(angelscript_dir.join("source/as_scriptobject.cpp"))
        .file(angelscript_dir.join("source/as_string.cpp"))
        .file(angelscript_dir.join("source/as_string_util.cpp"))
        .file(angelscript_dir.join("source/as_thread.cpp"))
        .file(angelscript_dir.join("source/as_tokenizer.cpp"))
        .file(angelscript_dir.join("source/as_typeinfo.cpp"))
        .file(angelscript_dir.join("source/as_variablescope.cpp"))
        .warnings(false)
        .compile("libanglescript.a");
